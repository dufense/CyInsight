...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_security_events_tenant_occurred
  ON security_events (tenant_id, occurred_at DESC);

-- security_events: used by event-type filtered queries (trend, investigation)
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_security_events_tenant_occurred_type
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_risk_scores_tenant_entity
